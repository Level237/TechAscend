...
export default function Header() {
  return (
    <header className="w-[100%] sticky  z-[30] bg-transparent backdrop-blur   border-b-[0.1px] dark:border-[#e8d1bb38] border-[#5134173a] top-0  py-4 px-4 sm:px-10 dark:bg-transparent  bg-[#003366]  font-[sans-serif] min-h-[90px]">
